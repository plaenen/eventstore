...
func main() {
	...
	fmt.Println("   keyPath := fmt.Sprintf(\"/prod/encryption/tenant/%s/key\", tenantID)")
	fmt.Println()
	...
	fmt.Println("           log.Fatalf(\"Failed to create key provider: %v\", err)")
	fmt.Println("       }")
	fmt.Println()
	fmt.Println("       creds, err := keyProvider.GetCredentials(ctx)")
	fmt.Println("       if err != nil {")
	fmt.Println("           log.Fatalf(\"Failed to get encryption key: %v\", err)")
	fmt.Println("       }")
	fmt.Println()
	fmt.Println("       // 2. Decode key from base64")
	fmt.Println("       key, err := base64.StdEncoding.DecodeString(creds.Token)")
	fmt.Println("       if err != nil {")
	fmt.Println("           log.Fatalf(\"Failed to decode key: %v\", err)")
	fmt.Println("       }")
	fmt.Println()
	fmt.Println("       // 3. Create encryption service")
	fmt.Println("       encService, err := encryption.NewService(key)")
	fmt.Println("       if err != nil {")
	fmt.Println("           log.Fatalf(\"Failed to create encryption service: %v\", err)")
	fmt.Println("       }")
	fmt.Println()
	...
	fmt.Println("       if err != nil {")
	fmt.Println("           log.Fatalf(\"Encryption failed: %v\", err)")
	fmt.Println("       }")
	fmt.Println()
