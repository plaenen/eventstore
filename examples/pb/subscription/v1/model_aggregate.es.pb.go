...
func NewSubscription(id string, applier SubscriptionEventApplier) *SubscriptionAggregate {
	return &SubscriptionAggregate{
		AggregateRoot: domain.NewAggregateRoot(id, "Subscription"),
...
type SubscriptionRepository struct {
	*store.BaseRepository[*SubscriptionAggregate]
}
...
func NewSubscriptionRepository(eventStore store.EventStore, factory func(string) *SubscriptionAggregate) *SubscriptionRepository {
	return &SubscriptionRepository{
		BaseRepository: store.NewRepository[*SubscriptionAggregate](
			eventStore,
			"Subscription",
			factory,
			func(agg *SubscriptionAggregate, event *domain.Event) error {
...
func deserializeEventSubscription(event *domain.Event) (proto.Message, error) {
...
type SubscriptionCreatedEventHandler func(ctx context.Context, event *SubscriptionCreatedEvent, envelope *domain.EventEnvelope) error
type SubscriptionCancelledEventHandler func(ctx context.Context, event *SubscriptionCancelledEvent, envelope *domain.EventEnvelope) error
...
func (b *SubscriptionProjectionBuilder) OnSubscriptionCreated(handler SubscriptionCreatedEventHandler) *SubscriptionProjectionBuilder {
	b.handlers[SubscriptionCreatedEventType] = func(ctx context.Context, envelope *domain.EventEnvelope) error {
		// Deserialize event
...
func (b *SubscriptionProjectionBuilder) OnSubscriptionCancelled(handler SubscriptionCancelledEventHandler) *SubscriptionProjectionBuilder {
	b.handlers[SubscriptionCancelledEventType] = func(ctx context.Context, envelope *domain.EventEnvelope) error {
		// Deserialize event
...
func OnSubscriptionCreated(handler SubscriptionCreatedEventHandler) store.EventHandlerRegistration {
...
func OnSubscriptionCancelled(handler SubscriptionCancelledEventHandler) store.EventHandlerRegistration {
	return store.EventHandlerRegistration{
...
func (p *SubscriptionProjection) Handle(ctx context.Context, envelope *domain.EventEnvelope) error {
