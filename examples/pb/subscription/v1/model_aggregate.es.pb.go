...
// SubscriptionAggregateBase is the base aggregate root for Subscription domain
// It embeds the proto-defined Subscription for state management
type SubscriptionAggregateBase struct {
	eventsourcing.AggregateRoot
	State   *Subscription
	applier SubscriptionEventApplier // Injected dependency for event application
}

// NewSubscriptionAggregateBase creates a new SubscriptionAggregateBase instance
// The applier parameter defines how events modify aggregate state
// Implement SubscriptionEventApplier in your domain layer
func NewSubscriptionAggregateBase(id string, applier SubscriptionEventApplier) *SubscriptionAggregateBase {
	return &SubscriptionAggregateBase{
...
func (a *SubscriptionAggregateBase) MarshalSnapshot() ([]byte, error) {
	return proto.Marshal(a.State)
}

// UnmarshalSnapshot deserializes the aggregate state from snapshots
func (a *SubscriptionAggregateBase) UnmarshalSnapshot(data []byte) error {
	...
	if upcaster, ok := interface{}(a).(eventsourcing.SnapshotUpcaster); ok {
		a.State = upcaster.UpcastSnapshot(a.State).(*Subscription)
	}
...
func (a *SubscriptionAggregateBase) GetState() *Subscription {
	return a.State
}

// ApplyEvent applies an event to the Subscription aggregate
// This method delegates to the injected applier implementation
func (a *SubscriptionAggregateBase) ApplyEvent(event proto.Message) error {
...
type SubscriptionEventApplier interface {
	...
	ApplySubscriptionCreatedEvent(agg *SubscriptionAggregateBase, e *SubscriptionCreatedEvent) error
	// ApplySubscriptionCancelledEvent applies the SubscriptionCancelledEvent to the aggregate state
	ApplySubscriptionCancelledEvent(agg *SubscriptionAggregateBase, e *SubscriptionCancelledEvent) error
}
...
//
// func (ap *AccountAppliers) ApplySubscriptionCreatedEvent(agg *accountv1.SubscriptionAggregateBase, e *accountv1.SubscriptionCreatedEvent) error {
//     // Update aggregate state
//     agg.State.SubscriptionId = e.SubscriptionId
//     return nil
// }
//
// func (ap *AccountAppliers) ApplySubscriptionCancelledEvent(agg *accountv1.SubscriptionAggregateBase, e *accountv1.SubscriptionCancelledEvent) error {
//     // Update aggregate state
//     agg.State.SubscriptionId = e.SubscriptionId
//     return nil
// }
...
//   agg := accountv1.NewSubscriptionAggregateBase(id, applier)
// ============================================================================
...
// Example:
//
// func (a *SubscriptionAggregateBase) UpcastEvent(event proto.Message) proto.Message {
...
func (a *SubscriptionAggregateBase) ApplySubscriptionCreatedEvent(event *SubscriptionCreatedEvent, opts ...ApplyEventOption) error {
...
// This eliminates the need to manually specify event type strings
func (a *SubscriptionAggregateBase) ApplySubscriptionCancelledEvent(event *SubscriptionCancelledEvent, opts ...ApplyEventOption) error {
	// 1. Apply to in-memory state immediately
	if err := a.ApplyEvent(event); err != nil {
		return err
	}
...
// SubscriptionAggregate defines the interface for Subscription aggregates
// Your domain aggregate must implement this interface
type SubscriptionAggregate interface {
	eventsourcing.Aggregate
	GetState() *Subscription
}

// SubscriptionRepository provides persistence for Subscription
type SubscriptionRepository[T SubscriptionAggregate] struct {
...
func NewSubscriptionRepository[T SubscriptionAggregate](eventStore eventsourcing.EventStore, factory func(string) T) *SubscriptionRepository[T] {
