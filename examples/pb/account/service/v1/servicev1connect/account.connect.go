...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/plaenen/eventstore/examples/pb/account/service/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AccountCommandServiceName = "account.service.v1.AccountCommandService"
	// AccountQueryServiceName is the fully-qualified name of the AccountQueryService service.
	AccountQueryServiceName = "account.service.v1.AccountQueryService"
)
...
const (
	...
	AccountCommandServiceOpenAccountProcedure = "/account.service.v1.AccountCommandService/OpenAccount"
	// AccountCommandServiceDepositProcedure is the fully-qualified name of the AccountCommandService's
	// Deposit RPC.
	AccountCommandServiceDepositProcedure = "/account.service.v1.AccountCommandService/Deposit"
	// AccountCommandServiceWithdrawProcedure is the fully-qualified name of the AccountCommandService's
	// Withdraw RPC.
	AccountCommandServiceWithdrawProcedure = "/account.service.v1.AccountCommandService/Withdraw"
	// AccountCommandServiceCloseAccountProcedure is the fully-qualified name of the
	// AccountCommandService's CloseAccount RPC.
	AccountCommandServiceCloseAccountProcedure = "/account.service.v1.AccountCommandService/CloseAccount"
	// AccountQueryServiceGetAccountProcedure is the fully-qualified name of the AccountQueryService's
	// GetAccount RPC.
	AccountQueryServiceGetAccountProcedure = "/account.service.v1.AccountQueryService/GetAccount"
	// AccountQueryServiceListAccountsProcedure is the fully-qualified name of the AccountQueryService's
	// ListAccounts RPC.
	AccountQueryServiceListAccountsProcedure = "/account.service.v1.AccountQueryService/ListAccounts"
	...
	AccountQueryServiceGetAccountBalanceProcedure = "/account.service.v1.AccountQueryService/GetAccountBalance"
	...
	AccountQueryServiceGetAccountHistoryProcedure = "/account.service.v1.AccountQueryService/GetAccountHistory"
)

// AccountCommandServiceClient is a client for the account.service.v1.AccountCommandService service.
...
// NewAccountCommandServiceClient constructs a client for the
// account.service.v1.AccountCommandService service. By default, it uses the Connect protocol with
...
func NewAccountCommandServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountCommandServiceClient {
	...
	accountCommandServiceMethods := v1.File_account_service_v1_account_proto.Services().ByName("AccountCommandService").Methods()
...
// OpenAccount calls account.service.v1.AccountCommandService.OpenAccount.
...
// Deposit calls account.service.v1.AccountCommandService.Deposit.
...
// Withdraw calls account.service.v1.AccountCommandService.Withdraw.
...
// CloseAccount calls account.service.v1.AccountCommandService.CloseAccount.
...
// AccountCommandServiceHandler is an implementation of the account.service.v1.AccountCommandService
// service.
...
func NewAccountCommandServiceHandler(svc AccountCommandServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/account.service.v1.AccountCommandService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountCommandServiceHandler) OpenAccount(context.Context, *connect.Request[v1.OpenAccountCommand]) (*connect.Response[v1.OpenAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountCommandService.OpenAccount is not implemented"))
}
...
func (UnimplementedAccountCommandServiceHandler) Deposit(context.Context, *connect.Request[v1.DepositCommand]) (*connect.Response[v1.DepositResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountCommandService.Deposit is not implemented"))
}
...
func (UnimplementedAccountCommandServiceHandler) Withdraw(context.Context, *connect.Request[v1.WithdrawCommand]) (*connect.Response[v1.WithdrawResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountCommandService.Withdraw is not implemented"))
}
...
func (UnimplementedAccountCommandServiceHandler) CloseAccount(context.Context, *connect.Request[v1.CloseAccountCommand]) (*connect.Response[v1.CloseAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountCommandService.CloseAccount is not implemented"))
}

// AccountQueryServiceClient is a client for the account.service.v1.AccountQueryService service.
...
// NewAccountQueryServiceClient constructs a client for the account.service.v1.AccountQueryService
...
func NewAccountQueryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountQueryServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	accountQueryServiceMethods := v1.File_account_service_v1_account_proto.Services().ByName("AccountQueryService").Methods()
...
// GetAccount calls account.service.v1.AccountQueryService.GetAccount.
...
// ListAccounts calls account.service.v1.AccountQueryService.ListAccounts.
...
// GetAccountBalance calls account.service.v1.AccountQueryService.GetAccountBalance.
...
// GetAccountHistory calls account.service.v1.AccountQueryService.GetAccountHistory.
...
// AccountQueryServiceHandler is an implementation of the account.service.v1.AccountQueryService
// service.
...
func NewAccountQueryServiceHandler(svc AccountQueryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/account.service.v1.AccountQueryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountQueryServiceHandler) GetAccount(context.Context, *connect.Request[v1.GetAccountRequest]) (*connect.Response[v1.AccountView], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountQueryService.GetAccount is not implemented"))
}
...
func (UnimplementedAccountQueryServiceHandler) ListAccounts(context.Context, *connect.Request[v1.ListAccountsRequest]) (*connect.Response[v1.ListAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountQueryService.ListAccounts is not implemented"))
}
...
func (UnimplementedAccountQueryServiceHandler) GetAccountBalance(context.Context, *connect.Request[v1.GetAccountBalanceRequest]) (*connect.Response[v1.BalanceView], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountQueryService.GetAccountBalance is not implemented"))
}
...
func (UnimplementedAccountQueryServiceHandler) GetAccountHistory(context.Context, *connect.Request[v1.GetAccountHistoryRequest]) (*connect.Response[v1.AccountHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("account.service.v1.AccountQueryService.GetAccountHistory is not implemented"))
}
